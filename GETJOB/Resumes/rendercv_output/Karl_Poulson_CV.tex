...
\usepackage[
    pdftitle={Karl Poulson's CV},
    pdfauthor={Karl Poulson},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Karl Poulson - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Tooele UT, USA}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:programmingnpc@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}programmingnpc@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+1-435-261-2293}{{\footnotesize\faPhone*}\hspace*{0.13cm}(435) 261-2293}}%
    \end{header}
